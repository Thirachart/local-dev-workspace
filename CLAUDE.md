# 🤖 Project Guidelines & Architecture (`chat-dev-mcp`)

## 📌 Project Overview
**Chat Dev MCP** (`chat-dev-mcp`) เป็น Model Context Protocol (MCP) Server พัฒนาด้วย **Node.js / TypeScript** ออกแบบมาเพื่อให้ AI Agents (ChatGPT, Claude Desktop, Claude Code, Cursor, Codex) สามารถควบคุมเครื่องมือพัฒนาโปรแกรมบนเครื่อง Local เช่น อ่าน/เขียน/แก้ไขโค้ด, รันคำสั่ง Terminal Shell, ค้นหาไฟล์, จัดการ Git และสลับพื้นที่ทำงานหลายโปรเจกต์พร้อมกัน
