            ...
            'application/json': {
              schema: {
                ...
                properties: {
                  ...
                  is_daemon: { type: 'boolean', description: 'Run as an explicit background daemon' },
                  detach_on_timeout: { type: 'boolean', description: 'Keep a timed-out foreground command running as a trackable background task. Defaults to false.' },
                  project: { type: 'string', description: 'Registered project name or id' },
                },
              },
            },
          },
