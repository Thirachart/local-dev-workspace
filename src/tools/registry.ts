...
const definitions: PublicToolMetadata[] = [
  ...
  { name: 'undo_operation', capability: 'write', mutation: true, snapshotPolicy: 'required', audit: true, compatibility: 'v2-native' },
  { name: 'get_mutation', capability: 'read', mutation: false, snapshotPolicy: 'observe', audit: false, compatibility: 'v2-native' },
  { name: 'file_changeset', capability: 'write', mutation: true, snapshotPolicy: 'required', audit: true, compatibility: 'v2-native' },
  { name: 'copy_file', capability: 'write', mutation: true, snapshotPolicy: 'required', audit: true, compatibility: 'v2-native' },
  { name: 'sync_file', capability: 'write', mutation: true, snapshotPolicy: 'required', audit: true, compatibility: 'v2-native' },
  { name: 'patch_json', capability: 'write', mutation: true, snapshotPolicy: 'required', audit: true, compatibility: 'v2-native' },
  { name: 'patch_yaml', capability: 'write', mutation: true, snapshotPolicy: 'required', audit: true, compatibility: 'v2-native' },
  { name: 'batch_file_ops', capability: 'read', mutation: false, snapshotPolicy: 'observe', audit: false, compatibility: 'v2-native' },
  ...
  { name: 'git_stage', capability: 'gitCommit', mutation: true, snapshotPolicy: 'observe', audit: true, compatibility: 'v2-native' },
  ...
  { name: 'project_registry_report', capability: 'none', mutation: false, snapshotPolicy: 'none', audit: false, compatibility: 'v2-native' },
